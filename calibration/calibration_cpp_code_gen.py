...
final_code_template = """/* Auto-generated by calibration_cpp_code_gen on (%s)[DD/MM/YYYY] for combined datasets:
%s
 */
...
def create_cpp_state_map(folders_descriptions, cw_template_title, cw_state_map, ccw_template_title, ccw_state_map):
